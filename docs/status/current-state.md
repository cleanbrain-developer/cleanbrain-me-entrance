...
2. Optional, deferred (not part of this review's fixes): a manual KO/EN language toggle, since locale is currently 100% inferred from the browser with no override — flagged during the review but not implemented pending a product decision.
